...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        //Task 3: _nodes exclusive ownership
                        //ref https://knowledge.udacity.com/questions/135760
                        //add const? https://knowledge.udacity.com/questions/129804
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // create new edge
                            //Task 4
                            // ref //https://knowledge.udacity.com/questions/353634
                            ...
                            //Task 4 move edge to child node as owner
                            //ref //https://knowledge.udacity.com/questions/353634
    ...
    //Task 5 Create ChatBot instance on stack 
    ...
    //Task 5 use move semantics to pass chatbot to node
